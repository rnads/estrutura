...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-6 text-right">
                        ...
                        <a href="<?php echo e(Route('admin.usuarios.show', $user->id)); ?>" class="btn btn-warning"><i class="fas fa-key"></i> Resetar Senha Padrão</a>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Renan A\Documents\Developer\estrutura\resources\views/admin/users/form.blade.php ENDPATH**/ ?>